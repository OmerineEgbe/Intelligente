...
const steps = [
  {
    ...
    options: [
      ...
      { value: 'directed', label: 'I have a career goal in mind', icon: Target },
      { value: 'validator', label: 'I\'ve chosen a program and want to confirm', icon: GraduationCap },
    ],
  },
  {
    id: 'interest',
  ...
  },
  {
    ...
    options: [
      { value: 'undergraduate', label: 'Undergraduate (BSc / BA)', icon: null },
      { value: 'postgraduate', label: 'Postgraduate (MSc / MBA)', icon: null },
      { value: 'phd', label: 'Doctorate (PhD)', icon: null },
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex flex-col">
      ...
      <div className="h-1 bg-[#e2e8f0]">
        <div
          className="h-full bg-[#0c1f4a] transition-all duration-500"
                ...
                <button
                  ...
                  className={`flex items-center gap-3 px-5 py-4 rounded-xl border text-left transition-all font-medium text-sm
                    ${selected === opt.value
                      ...
                      : 'border-[#e2e8f0] bg-white text-[#0c1f4a] hover:border-[#1a3461] hover:bg-[#f8fafc]'
                    }`}
                >
                  {Icon && (
                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${
                      selected === opt.value ? 'bg-white/20' : 'bg-[#dbeafe]'
                    }`}>
